    ...
    def draw_samples(self, zinit_D=None, n_keep_samples=1, n_burnin_samples=0):
        ...
        for s in range(K + B):
            for p, rw_stddev_D in enumerate(self.list_of_rw_stddev_D):
                ...
                # zprime_D = z_D + eps_D * rw_stddev_D # okay
                # print("z_D: ", z_D)
                # print("rw_stddev_D:", rw_stddev_D)
                # print("esp_D:", eps_D)
                # print("z_D:", z_D)
                zprime_D = z_D +  rw_stddev_D * eps_D
                # print("zprime_D: ", zprime_D)
                ...
                # print("u_accept: ", u_accept)
                # print("A: ", A)
                did_accept = (u_accept <= A) # TODO FIXME  okay
                # print("did_accept:", did_accept)
                if did_accept:
                    # Accepted proposal.
                    # update the sampler state to its new value
                    znew_D = zprime_D # Okay
