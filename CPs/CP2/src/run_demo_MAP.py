...
if __name__ == '__main__':    
    ...
    # print("x_train_ND:", x_train_ND)
    # print("x_train_ND[:5]:", x_train_ND[:5])
    # print("t_train_N:", t_train_N)
    # print("t_train_N[:5]:", t_train_N[:5])
    ...
    for fig_col_id in range(len(order_list)):
        ...
        print("score:", map_estimator.score(x_train_ND[:N], t_train_N[:N]))
